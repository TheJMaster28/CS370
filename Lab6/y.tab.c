...
{
       0,    49,    49,    51,    52,    56,    57,    59,    63,    67,
      72,    77,    84,    85,    86,    88,    96,    99,   101,   102,
     106,   110,   116,   121,   122,   126,   127,   136,   137,   138,
     139,   140,   141,   142,   143,   145,   146,   148,   153,   161,
     166,   167,   171,   175,   178,   183,   185,   188,   194,   195,
     201,   202,   203,   204,   205,   206,   208,   209,   215,   216,
     218,   219,   225,   226,   227,   228,   230,   231,   234,   235,
     236,   239,   242,   247,   252,   253,   255,   256
};
#endif
...
#line 63 "lab6.y" /* yacc.c:1652  */
    { (yyval.node) = ASTCreateNode(VARDEC); /* create node */    /* var-list -> ID | ID [NUM] | ID , var-list | ID[NUM] , var-list */
                      ...
                      (yyval.node)->sysType = Type; /* set type according to the typeSp */ 
                      }
#line 1416 "y.tab.c" /* yacc.c:1652  */
    break;

  case 9:
#line 67 "lab6.y" /* yacc.c:1652  */
    { (yyval.node) = ASTCreateNode(VARDEC); /* creates node */
                                 ...
                                 (yyval.node)->sysType = Type; /* sets Type accroding to typeSP */
                                 }
#line 1426 "y.tab.c" /* yacc.c:1652  */
    break;

  case 10:
#line 72 "lab6.y" /* yacc.c:1652  */
    { (yyval.node) = ASTCreateNode(VARDEC);
                                 (yyval.node)->name = (yyvsp[-2].string);
                                 (yyval.node)->sysType = Type;
...
#line 84 "lab6.y" /* yacc.c:1652  */
    { Type = INTTYPE;  /* sets type of the function or variable */}
#line 1453 "y.tab.c" /* yacc.c:1652  */
    break;

  case 13:
#line 85 "lab6.y" /* yacc.c:1652  */
    { Type = VOIDTYPE; }
...
#line 88 "lab6.y" /* yacc.c:1652  */
    { 
                                                     ...
                                                     (yyval.node)->sysType = Type; /* sets type of the funtion */
                                                     }
#line 1477 "y.tab.c" /* yacc.c:1652  */
    break;

  case 16:
#line 96 "lab6.y" /* yacc.c:1652  */
...
#line 1485 "y.tab.c" /* yacc.c:1652  */
  ...
  case 17:
#line 99 "lab6.y" /* yacc.c:1652  */
    { (yyval.node) = (yyvsp[0].node); }
#line 1491 "y.tab.c" /* yacc.c:1652  */
    break;

  case 18:
#line 101 "lab6.y" /* yacc.c:1652  */
    { (yyval.node) = (yyvsp[0].node); }
...
#line 1547 "y.tab.c" /* yacc.c:1652  */
  ...
  case 25:
#line 126 "lab6.y" /* yacc.c:1652  */
    {(yyval.node) = NULL; }
#line 1553 "y.tab.c" /* yacc.c:1652  */
    break;

  case 26:
#line 127 "lab6.y" /* yacc.c:1652  */
...
#line 1590 "y.tab.c" /* yacc.c:1652  */
  ...
  case 31:
#line 140 "lab6.y" /* yacc.c:1652  */
    { (yyval.node) = (yyvsp[0].node); }
#line 1596 "y.tab.c" /* yacc.c:1652  */
    break;

  case 32:
#line 141 "lab6.y" /* yacc.c:1652  */
    { (yyval.node) = (yyvsp[0].node); }
#line 1602 "y.tab.c" /* yacc.c:1652  */
    break;

  case 33:
#line 142 "lab6.y" /* yacc.c:1652  */
    { (yyval.node) = (yyvsp[0].node); }
...
#line 148 "lab6.y" /* yacc.c:1652  */
    { (yyval.node) = ASTCreateNode(STMT); /* creates a STMT node */
                                                     (yyval.node)->s1 = ASTCreateNode(IFTHEN); /* creates a IFTHEN node in the STMT's s1 */
...
#line 153 "lab6.y" /* yacc.c:1652  */
    { (yyval.node) = ASTCreateNode(STMT); 
                                                                    (yyval.node)->s1 = ASTCreateNode(IFTHEN); 
                                                                    ((yyval.node)->s1)->s1 = (yyvsp[-4].node); 
                                                                    ((yyval.node)->s1)->s2 = (yyvsp[-2].node); 
                                                                    (yyval.node)->s2 = ASTCreateNode(ELSESTMT); /* creats an ELSESTMT in STMT's s2 */
...
#line 1765 "y.tab.c" /* yacc.c:1652  */
  ...
  case 55:
#line 206 "lab6.y" /* yacc.c:1652  */
    { (yyval.types) = NET; }
#line 1771 "y.tab.c" /* yacc.c:1652  */
    break;

  case 56:
#line 208 "lab6.y" /* yacc.c:1652  */
    { (yyval.node) = (yyvsp[0].node); }
...
#line 1917 "y.tab.c" /* yacc.c:1652  */
  ...
  case 77:
#line 256 "lab6.y" /* yacc.c:1652  */
    { (yyvsp[-2].node)->next = (yyvsp[0].node); /* chains argList together with next to expression's node */
                                         (yyval.node) = (yyvsp[-2].node); /* passes expression node */
                                         }
